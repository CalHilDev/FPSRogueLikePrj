...
reload(mm)
mat = mm.Material('MossyRockT', True)
mat.clear()
TextureSample_Color = mat.add_node('TextureSample', -400, -176)
TextureSample_Color.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/MossyRockT_albedo.png', '/Game/Textures'))
...
TextureSample_ORM.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/MossyRockT_orm.png', '/Game/Textures'))
...
TextureSample_Normal.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/MossyRockT_normal.png', '/Game/Textures'))
...
TextureObject_0.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/MossyRockT_height.png', '/Game/Textures'))
