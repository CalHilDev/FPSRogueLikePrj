import unreal
import sys
sys.path.append('C:/Users/Husky Cal/Documents/material_maker_1_4_windows/export')
import mm
from importlib import reload
reload(mm)
mat = mm.Material('StoneBrickTexture1', True)
mat.clear()
TextureSample_Color = mat.add_node('TextureSample', -400, -176)
TextureSample_Color.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/StoneBrickTexture1_albedo.png', '/Game/Textures'))
...
TextureSample_ORM.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/StoneBrickTexture1_orm.png', '/Game/Textures'))
...
TextureSample_Normal.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/StoneBrickTexture1_normal.png', '/Game/Textures'))
...
TextureObject_0.set_editor_property('texture', mm.import_texture('F:/Pro/FPSRogueLikePrj/FPSRogueLike 5.5/Content/Landscape/Textures/StoneBrickTexture1_height.png', '/Game/Textures'))
